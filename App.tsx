            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <div className="relative w-full sm:w-96 group">
                <input 
                  ...
                  className="w-full bg-white border border-slate-200 rounded-2xl px-6 py-4 pl-12 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all text-sm font-medium"
                />
