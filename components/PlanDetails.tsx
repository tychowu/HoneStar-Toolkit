          ...
          {plan.note && (
            <div className="bg-[#fffdf2] p-6 rounded-2xl border border-[#fef3c7] flex gap-4">
              ...
              <div>
                ...
                <p className="text-[#b45309] text-sm leading-relaxed font-medium">{plan.note}</p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="flex gap-5">
              <div className="w-12 h-12 rounded-2xl bg-orange-50 flex items-center justify-center shrink-0 text-orange-600">
                <Icons.Bot className="w-6 h-6" /> {/* Using Bot icon as placeholder for chart/performance if available */}
              </div>
              <div className="flex-1">
