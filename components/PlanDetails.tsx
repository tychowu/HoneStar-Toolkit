      ...
      >
        ...
        <div className="px-8 py-6 flex justify-between items-center border-b border-slate-50">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-800 tracking-tight">{plan.name}</h2>
          </div>
            ...
            <div className="absolute inset-0 z-20 bg-slate-50 flex flex-col animate-in slide-in-from-right duration-300">
              <div className="px-8 py-4 bg-white border-b border-slate-200 flex justify-between items-center shadow-sm relative z-10">
                ...
                <button 
                  ...
                  className="px-4 py-1.5 bg-slate-900 text-white rounded-xl text-sm font-bold hover:bg-slate-800 transition-colors shadow-md"
                >
                  返回摘要
                </button>
              </div>
              <div className="flex-1 overflow-y-auto p-6 md:p-10 hide-scrollbar bg-slate-50">
                <div className="bg-white p-8 md:p-16 rounded-3xl shadow-xl border border-slate-200 mx-auto max-w-3xl min-h-full">
                  <div 
                    className="prose prose-slate prose-sm md:prose-base max-w-none text-slate-700 font-medium leading-relaxed prose-headings:text-slate-900 prose-headings:font-extrabold prose-strong:text-slate-900 prose-a:text-blue-600"
        ...
        <div className="px-8 py-6 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
          ...
          >
            <Icons.Info className="w-5 h-5 group-hover:scale-110 transition-transform" />
            <span>查看源文件详情</span>
          </button>
          <button 
            onClick={onClose}
