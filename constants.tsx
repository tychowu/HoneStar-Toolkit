...
export const PLANS: FinancialPlan[] = [
  ...
  },
  {
    ...
    details: {
      ...
      clawback: "如下则所有融资立即整笔一次全額偿还：\n■ 不当行为导致协议终止\n■ 36个月内与非保诚的保险或金融机构在香港登记或签任何贷款协议\n■ 业务产出不再符合业务产出要求。"
    }
  },
  {
    id: "D123",
  ...
  },
  {
    ...
    details: {
      ...
      clawback: "(d) 60个月内协议被终止（严格执行）：\n■ 1~12个月：退100%预支\n■ 13~24个月：退100%预支\n■ 25~35个月：退100%业绩花红\n■ 37~48个月：退部分业绩花红（具体参照合约）\n\n如有以下融资立即一次全额偿还：\n(a)不当行为导致相关协议终止；\n(b)24个月末前终止本协议下的委任；\n(c)25~36个月内终止本协议下的委任，且与非保诚的保险或金融机构在香港登记或签任何贷款协议。"
    }
  },
  {
    id: "V104",
    ...
    qualification: "■ 首次于保险业监管局登记（银行从业不受此限制）\n■ 2年及以上指定工作经验（包括不限于专业人士/销售/客服/管理）或学士学位或以上\n■ 申请人FC/UM，招募经理UM及以上\n■ 要求全职",
    tag: "董监高首选",
    ...
    details: {
      ...
      funding: "1、每月固定预支：20,000港币（2年共48万）。\n2、第2年年末额外花红（需达标）：\n■ 两年总业绩达到240万，额外12万；\n■ 总业绩达到288万，额外24万。\n3、第3年年末额外花红（需达标）：\n■ 三年总业绩达到336万，额外12万；\n■ 总业绩达到384万，额外24万；\n■ 总业绩达到432万，额外36万。\n4、理论最高总收入：108万（两年预支48万+各类花红）。",
      performance: "1、对数要求：每月6.5万业绩，每年78万业绩。\n2、两年累计要求：共156万业绩，且需隔月批单。\n3、单数要求：两年总保单数超过24张（其中H&P医疗及保障类保单需占总业绩的15%）。",
      clawback: "1、4年内离职需退回预支：\n■ 新人2年内离职，退回100%；\n■ 第3年内离职，退回60%；\n■ 第4年内离职，退回40%。\n2、上线经理连带责任：第一年内离职，所有上线经理退回Overriding；如新人不退还，直属SUM或以上经理需按比例（40%/40%/30%/20%）退还公司。"
    }
  },
  {
    id: "D119",
    ...
    details: {
      ...
      funding: "1、一次性或分阶段的大额启动奖金（Lump Sum）。\n2、金额通常基于过往年薪的一定比例（如20%-50%）计算，作为转行补偿。",
      performance: "1、需在特定时间内（如首6个月或首年）完成指定业绩以“解锁”或保留奖金。\n2、通常不设月度预支，强调快速启动。",
      clawback: "如有以下情况，需立即一次全额偿还所有已发融资：\n(a)不当行为导致相关协议终止；\n(b)24个月末前终止本协议下的委任；\n(c)与非保诚机构签任何贷款协议（包括直接或间接，无论何种身份）。"
    }
  }
];
